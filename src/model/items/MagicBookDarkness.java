...
public class MagicBookDarkness extends MagicBook {

    /**
     * Creates a new bow.
     * <p>
     * Magic Books are weapons that can attack  units with dark magic that have a large range
     *
     * @param name
    ...
    public MagicBookDarkness(final String name, final int power, final int minRange, final int maxRange) {
